...
For more information on the JSON Path syntax used to query JSON documents in Redis, see the [JSON documentation](https://oss.redis.com/redisjson/path/).
